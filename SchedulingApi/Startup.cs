    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSwaggerGen(c =>
            {
                ...
                {
                    Title = "API DE MARCAÇÃO DE DATA NO POSTO",
                    Version = "v1",
                    Description = "Uma Api para auxiliar e facilitar no agendamento de consultas no posto de saúde",
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "API DE MARCAÇÃO DE DATA NO POSTO");
